...
export const EducationList = () => {
	...
	const optimisticUpdate = async (newEducations, updateNotify) => {
	...
	const handleCreate = (data) => optimisticUpdate([...educations, data], 'Thêm liên hệ');
...
function EducationModal({ open, onClose, data, onSubmit }) {
