...
import { AlbumModal } from '@/views/user/components';
import { toast } from 'react-hot-toast';
import { updateAlbumApi } from '@/views/user/api/updateAlbum.api';
import { createAlbumApi } from '@/views/user/api/createAlbum.api';
import { dateUtil, urlUtil } from '@/common/utils';
import { PrivacyDropdown } from '@/common/components/Button';
import { AlbumDetail } from '@/views/user/components/AlbumDetail.component';
...
export function AlbumTab() {
	...
	const albumFetcher = useSWRFetcher({ api: `/users/${user._id}/albums` });
	...
	const handleChangePrivacy = async (album, privacy) => {
