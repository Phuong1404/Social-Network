...
import { acceptFriendApi, rejectFriendApi, requestFriendApi, unFriendApi } from '@/views/friend/api';
import { useRouter } from 'next/router';
import { createConversationApi } from '@/views/messages/api';

export const useUserAction = (user) => {
	...
	const handleAcceptFriend = async () => {
		...
		try {
			...
			toast.success('Xác nhận lời mời kết bạn thành công!', { id: toastId });
