...
import { changeNicknameApi, changeRoleApi, removeMemberApi } from '@/views/messages/api';


export function MemberDropdown({ conversation, member, onUpdateMember, ...props }) {
	...
	const handleChangeNickname = async (values) => {
