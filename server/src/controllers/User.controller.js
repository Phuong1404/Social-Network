...
} = require('../utils/Activity/friend.activity.util');
const { calculateCosineSimilarity } = require('../utils/Suggest/Friend.suggest');
const { responseError } = require('../utils/Response/error');

function SearchAllUsers(req) {
	try {
...
async function SearchSuggestFriends(req, next) {
	try {
