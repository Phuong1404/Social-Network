    ...
    <div style="background-color: #f5f5f5; padding: 20px 0;">
        <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px;">
            ...
            <div style="text-align: center; margin-bottom: 20px;">
                ...
                <p style="color: #333; font-size: 16px; margin-bottom: 10px;">Cảm ơn bạn đã đăng ký tài khoản của Social netwrok.</p>
            ...
            <div style="text-align: center; margin-bottom: 20px;">
                ...
                <p style="color: #333; font-size: 16px; margin-bottom: 10px;">&nbsp;Social netwrok</p>
            </div>
        </div>
    </div>
    `;
